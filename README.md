...
|  [Leveraging pre-trained language models for mining microbiome-disease relationships](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-023-05411-z)  |  DDI  |P R F1 |
...
|  [Do instruction-tuned large language models help with relation extraction?](https://ceur-ws.org/Vol-3577/paper15.pdf) | P R micro-F1 macro-F1 | ChemProt、DDI  |
|  [AutoRE: Document-level relation extraction with large language models](https://aclanthology.org/2024.acl-demos.20/) |  P R micro-F1   |  ChemProt、DDI  |[GitHub](https://github.com/thudm/autore)|
